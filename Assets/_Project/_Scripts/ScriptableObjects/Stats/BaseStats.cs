...
namespace GoodVillageGames.Core.Character.Attributes
{
    ...
    public class BaseStats : ScriptableObject
    {
        ...
        [Group("Interaction")] public float InteractRange = 10f;    // Base Max Interact Range
        [Group("Interaction")] public float CollectRange = 20f;     // Base Max Item Collection Range
        ...
        [Group("Boost")] public float DashTime = 2f;                // Base Max Dashing Time
        [Group("Boost")] public float DashSpeed = 20f;              // Base Max Dashing Speed
        [Group("Boost")] public float DashRechargeRate = 5f;        // Base Max Dashing Recharging Rate
    }
}